...
Zcash Custody Voter is designed to keep the customer's voting authority separate from the custodian's control of funds. The customer hotkey is voting-only material generated by `zcash_voting`; it is not a wallet seed, mnemonic, or custody spending key.
